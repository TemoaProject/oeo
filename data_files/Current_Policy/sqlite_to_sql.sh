...
input_file="US_9R_TS_fixed.sqlite"

# Initialize the combined output file
schema_output="table_schema_TS_fix.sql"
sets_output="sets_TS_fix.sql"
time_independent_output="timestep_independent_params_TS_fix.sql"
time_dependent_output="timestep_dependent_params_TS_fix.sql"
